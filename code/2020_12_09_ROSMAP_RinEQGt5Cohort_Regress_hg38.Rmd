...
COUNT <- COUNT[ (row.names(COUNT) %in% c("ENSG00000239467", "ENSG00000005486", "ENSG00000160972", "ENSG00000165886", "ENSG00000002330", "ENSG00000149823", "ENSG00000139722", "ENSG00000169217", "ENSG00000127774", "ENSG00000122490", "ENSG00000130881", "ENSG00000126005", "ENSG00000171222", "ENSG00000070413", "ENSG00000211459")) == F, ]
...
#Filter for Rin Here#
Meta <- Meta[ Meta$RIN >= 5 | Meta$sampleid %in% c('380_120503','500_120515'), ]
...
genesToAnalyze = unlist(genesToAnalyze) %>% 
  ...
  setdiff( c("ENSG00000239467", "ENSG00000005486", "ENSG00000160972", "ENSG00000165886", "ENSG00000002330", "ENSG00000149823", "ENSG00000139722", "ENSG00000169217", "ENSG00000127774", "ENSG00000122490", "ENSG00000130881", "ENSG00000126005", "ENSG00000171222", "ENSG00000070413", "ENSG00000211459") )
...
colnames(FIT$coefficients) <- gsub( 'Tissue.Diagnosis.SEX','',colnames(FIT$coefficients))
# Fit contrast
...
thisFileName <- '2020_12_09_ROSMAP_RinEQGt5Cohort_Regress_hg38.Rmd'
# Github link
...
CODE <- syn_temp$store(synapseclient$Folder(name = "RinOver5_RosMap_OldCode", parentId = "syn23640229"))
...
```{r knitmd, eval=FALSE, cache=FALSE, include=FALSE}
  ...
  createAndKnitToFolderEntityClient(file = "2020_12_09_ROSMAP_RinEQGt5Cohort_Regress_hg38.Rmd",
                                          parentId ="syn23640229",
                                          folderName = 'RinOver5_RosMap_OldCode')
