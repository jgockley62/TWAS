...
AltMeta <- 'syn16783596'
alt = downloadFile_version(AltMeta, version = 1)
...
#_#Removed 'FlowCellBatch'
FactorCovariates <- c('Individual_ID', "Institution", "Reported_Gender", "LibraryBatch", "Tissue", "Dx.Tissue", "Dx", "RibozeroBatch")
...
postAdjustCovars = c('Institution', 'Reported_Gender'); #'FlowcellBatch'
...
```{r ACC_Val, include=FALSE, eval=TRUE, cache=FALSE}
################################################################################
#CMC ACC DATA
library(stringr)
