...
FactorCovariates <- c("individualIdentifier", "batch", "RACE", "Sex", "Tissue.Diagnosis", "Tissue.APOE4", "Diagnosis")
...
thisFileName <- 'MSBB_RegressDiagnosis_4_TWAS.Rmd'
# Github link
...
# Code WTF is this??
CODE <- Folder(name = "MSBB", parentId = parentId)
CODE <- synStore(CODE)

#Set Used SynIDs For Provenance
Syns_Used <- c("syn8691099", "syn10156693", "syn8698270", 
               "syn8449369", "syn6100548", "syn6101474"
)
...
ENRICH_OBJ = File('MSBB_SVA_Diagnosis_Corrected.tsv', 
...
ENRICH_OBJ = File('MSBB_SVA_Diagnosis_Covariates.tsv', 
                  name = 'Covariates', 
                  parentId = CODE$properties$id)
ENRICH_OBJ = synStore(ENRICH_OBJ, used = Syns_Used, activityName = activityName, 
                      executed = thisFile, activityDescription = activityDescription)
...
ENRICH_OBJ = File('MSBB_Diagnosis_Regressed_Counts.tsv', 
...
ENRICH_OBJ = File('MSBB_Diagnosis_Regressed_logCPM.tsv', 
...
ENRICH_OBJ = File('MSBB_Diagnosis_Regressed_offset.tsv', 
...
ENRICH_OBJ = File('MSBB_Diagnosis_Regressed_Design.tsv', 
                  name = 'Design Matrix', 
                  parentId = CODE$properties$id)
ENRICH_OBJ = synStore(ENRICH_OBJ, used = Syns_Used, activityName = activityName, 
                      executed = thisFile, activityDescription = activityDescription)
...
ENRICH_OBJ = File('MSBB_Diagnosis_Regressed_SurVar.tsv', 
...
ENRICH_OBJ = File('MSBB_Diagnosis_Regressed_netResidualExpression.tsv', 
...
synLogin()
knit2synapse::createAndKnitToFolderEntity(file = "/home/jgockley/TWAS/code/MSBB_RegressDiagnosis_4_TWAS.Rmd",
                                          parentId ="syn20798011",
                                          folderName = 'MSBB')
```
