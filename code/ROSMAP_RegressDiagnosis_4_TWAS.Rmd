...
### Save Environment and SVA.GENE_EXPRESSION
```{r SAVE and Wrap, eval = F}
save.image("ROSMAP.RData")
write.table(RESIDUAL.SVA.GENE_EXPRESSION, file = "ROSMAP_SVA_Diagnosis_Corrected.tsv", row.names = T, col.names = T, sep ="\t", quote=F)
```
...
synapseLogin()
knit2synapse::knitfile2synapse(file = "./ROSMAP_RegressDiagnosis_4_TWAS.Rmd",
                                 owner = "syn20798014")
```
