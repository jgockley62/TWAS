...
activityDescription = 'CMCCovariate analysis and Regrsison of AD Diagnosis of aligned effective counts with GRCh38 with CQN normalisation (ACC)';
...
createAndKnitToFolderEntityClient(file = "CMC_ACC_Exp_DataProcessing",
                                          parentId ="syn21478397",
                                          folderName = 'ACC')
```