...
ENRICH_OBJ <- syn_temp$store( synapseclient$File( path='REPLACE TEST VALUE', name = 'REPLACE TEST VALUE', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, executed = thisFile, activityDescription = activityDescription)
