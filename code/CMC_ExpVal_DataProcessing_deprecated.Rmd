...
# Primary variable of interest - , 'Dx'- 
...
#InstitutionPitt Reported_GenderMale DxOther DxControl DxSCZ 
...
FIT = lmFit(VOOM.WEIGHTS$E,
            ...
            #_#design = VOOM.WEIGHTS$design[,colnames(VOOM.NET.FIT)[ colnames(VOOM.NET.FIT) %in% colnames(VOOM.WEIGHTS$design)] ],
