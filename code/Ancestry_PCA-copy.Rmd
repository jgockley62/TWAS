...
source ~/.bashrc
PATH=$PATH:/home/jgockley/TWAS/plink-1.07-x86_64/
...
do
    ...
    plink --vcf ALL.chr$i\.integrated_phase1_v3.20101123.snps_indels_svs.genotypes.vcf --threads $CORES --make-bed --out 1000Genomes_chr$i
  rm ALL.chr$i\.integrated_phase1_v3.20101123.snps_indels_svs.genotypes.vcf

done

#Merge All Plink Files into genome wide
for i in {2..22}
do
