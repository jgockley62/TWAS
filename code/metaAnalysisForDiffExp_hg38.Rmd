...
activityName = 'Meta analysis of differential expression hg38 Reprocessed';
activityDescription = 'Fixed and random effect meta-analysis of AMP-AD data hg38 Reprocessed Data (all 7 brain regions)';
thisFileName <- 'metaAnalysisForDiffExp_hg38.Rmd'
# Github link
...
#CODE = Folder(name = 'MetaAnalysis', parentId = parentId)
#CODE = synStore(CODE)
...
ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='meta.anlz.ad_cntrl.tsv', name = 'AD-Control meta-analysis across 7 brain regions hg38 Reprocessed Data', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, executed = thisFile, activityDescription = activityDescription)


# Write results to files
fwrite(meta.anlz.ad_cntrl.sex, file = 'meta.anlz.ad_cntrl.sex.tsv', sep = '\t', row.names = F, quote = F)
ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='meta.anlz.ad_cntrl.sex.tsv', name = 'AD-Control meta-analysis across 7 brain regions (sex specific) hg38 Reprocessed Data', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, executed = thisFile, activityDescription = activityDescription)

# Write results to files
fwrite(meta.anlz.apoe4_2_0, file = 'meta.anlz.apoe4_2_0.sex.tsv', sep = '\t', row.names = F, quote = F)
ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='meta.anlz.apoe4_2_0.sex.tsv', name = 'AD-Control meta-analysis across 7 brain regions (APOE4) hg38 Reprocessed Data', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, executed = thisFile, activityDescription = activityDescription)
...
createAndKnitToFolderEntityClient(file = "metaAnalysisForDiffExp_hg38.Rmd",
                                 parentId = "syn18936948",
                                 folderName = "MetaAnalysis")
```
