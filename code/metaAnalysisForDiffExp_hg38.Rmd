...
# Github link
thisRepo <- getRepo(repository = "jgockley62/TWAS", ref="branch", refName='geneLevelAnalysis')
...
knit2synapse::knitToFolderEntity(file = "metaAnalysisForDiffExp_hg38.Rmd",
                                 parentId = "syn21313899",
