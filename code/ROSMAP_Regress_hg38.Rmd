...
GENE.PARAM = syn_temp$get('syn21156161', version = 2)$path %>%
...
#Remove duplicated row for sampleid:
...
thisFileName <- 'ROSMAP_Regress_hg38.Rmd'
# Github link
...
activityName = 'Covariate Regression';
activityDescription = 'Covariate analysis and Regression of aligned effective counts with GRCh37 with CQN normalisation (DLPFC)';

CODE <- syn_temp$store(synapseclient$Folder(name = "ROSMAP", parentId = parentId))

Syns_Used <- c("syn3382527", "syn4300313", "syn21156161", "syn7116000",
  "syn21075911", "syn3191087", "syn21075913", "syn21075912"
)
# Set annotations
...
# Store SVA results
write.table(RESIDUAL.SVA.GENE_EXPRESSION, file = 'ROSMAP_Corrected.tsv', sep = '\t', quote=F)
...
createAndKnitToFolderEntityClient(file = "ROSMAP_Regress_hg38.Rmd",
                                          parentId ="syn21277617",
                                          folderName = 'ROSMAP')
