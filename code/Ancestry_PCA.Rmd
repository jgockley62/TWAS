...
```{r ReNamer_ONE, echo=F, results='hide'}
system("python Python/First_Rename.py")
```
...
```{r ReNamer_Two_Mayo, echo=T, results='hide'}
system("python Python/Second_Rename.py")
```
...
### ReName the Mayo SNPS so the can be combined
```{r ReNamer_Three_Rosmap, echo=T, results='hide'}
system("python Python/Third_Rename.py")
```
