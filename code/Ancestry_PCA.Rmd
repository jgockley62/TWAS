...
```{bash pull_1000Genomes, cache = FALSE, echo=FALSE}
source ~/.bashrc
...
```{bash ProcessMSBB, cache = FALSE, echo=FALSE}
source ~/.bashrc
PATH=$PATH:/home/jgockley/TWAS/bin/
CORES=`expr $(nproc) - 2`
...
```{bash DosageToHardCalls, cache = FALSE}
source ~/.bashrc
PATH=$PATH:/home/jgockley/TWAS/bin/
CORES=`expr $(nproc) - 2`
