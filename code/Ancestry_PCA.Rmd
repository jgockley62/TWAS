...
#_#plink --bfile 1000Genomes_chr1 --merge-list Merge.list --make-bed --out 1000Genomes_Merged
plink --bfile 1000Genomes_chr20 --merge-list Merge.list --make-bed --out 1000Genomes_Merged
...
do
  ...
  plink --file GWAS_Plink/MSSB_Chr_$i --threads $CORES --make-bed --allow-no-sex --snps-only --out GWAS_Plink/MSSB_Chr_$i
