...
EXP.all.annotations$dataSubType = 'CEU_INDV'
...
EXP.all.annotations$dataSubType = 'EigenVecs'
syn_temp$setAnnotations(ENRICH_OBJ, annotations = all.annotations)
...
EXP.all.annotations$dataSubType = 'EigenValues'
syn_temp$setAnnotations(ENRICH_OBJ, annotations = all.annotations)
...
EXP.all.annotations$dataSubType = 'GWAS'
syn_temp$setAnnotations(ENRICH_OBJ, annotations = all.annotations)
...
```{bash Clean, echo=T, eval=F, results='hide'}
rm -r ~/TWAS/bin/
rm *.bed
rm *.fam
rm *.bim
