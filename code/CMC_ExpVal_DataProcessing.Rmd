...
#Upload Plots:
ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='ACC_Val.pdf', name = 'LogP value as a function of correlation for ACC', parentId=CODE$properties$id ), activityName = activityName, executed = thisFile, activityDescription = activityDescription)
...
ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='PFC_Val.pdf', name = 'LogP value as a function of correlation for DLPFC', parentId=CODE$properties$id ), activityName = activityName, executed = thisFile, activityDescription = activityDescription)
